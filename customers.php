    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_customer.php?operation=create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Adicionar novo</a>
            </div>
        </div>
    </div>
                    ...
                    <form action="delete_customer.php" method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>Tem certeza de que deseja excluir esta linha?</p>
                            </div>
